...
package PgSqlExtract::ExpressionAnalyzer::AnalyzerList;
use warnings;
use strict;
use Carp;
use utf8;
use PgSqlExtract::ExpressionAnalyzer::ScopeAnalyzer;
...
sub new {
    ...
    $self->{INDEX}  = 0;
    $self->{LIST} = [
        PgSqlExtract::ExpressionAnalyzer::ScopeAnalyzer->new(),
    ];
    return $self;
}
